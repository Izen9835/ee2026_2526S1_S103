...
HD_PWD='C:/EE2026_WS/S1_03_FDP/S1_03_FDP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decayTimerTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decayTimerTest.tcl -notrace
