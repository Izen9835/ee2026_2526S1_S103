...
HD_PWD='C:/EE2026_WS/S1_03_FDP/S1_03_FDP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decayTimerTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decayTimerTest.tcl
